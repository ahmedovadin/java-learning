...
public class ArrayFunctionsApp {
    ...
    public static void main(String[] args) {
        ...
        if(Arrays.equals(lastFivePoints, topFivePoints)){
            System.out.println("The last 5 players have the same points as the top players");
        } else{
            System.out.println("The last 5 players don't have the same points as the top players");
        }
